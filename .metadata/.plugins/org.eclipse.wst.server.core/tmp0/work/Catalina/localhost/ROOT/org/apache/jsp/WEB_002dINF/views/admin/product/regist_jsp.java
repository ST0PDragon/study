 ...
 * Generated at: 2022-02-24 18:15:43 UTC
...
public final class regist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/admin/product/../../inc/sidebar.jsp", Long.valueOf(1645555590492L));
    _jspx_dependants.put("/WEB-INF/views/admin/product/../../inc/navbar.jsp", Long.valueOf(1645555500516L));
...
if(category.getDepth()>0){
      ...
      out.write("\r\n");
      out.write("                        <a href=\"javascript:selCategory('");
      ...
      out.write("            </div>\r\n");
      out.write("            </div>\r\n");
      out.write("          <!-- 카테고리 테이블 end -->\r\n");
      out.write("          \r\n");
      out.write("          <!-- 상품 등록폼 begin -->\r\n");
      ...
      out.write("              <form name=\"form1\" enctype=\"multipart/form-data\">\r\n");
      out.write("                <div class=\"card-body\">\r\n");
      out.write("                \r\n");
      out.write("                  <div class=\"form-group\">\r\n");
      out.write("                    <select class=\"form-control\" id=\"category_id\" name=\"category.category_id\">\r\n");
      out.write("                    	<option>좌측에서 카테고리 선택</option>\r\n");
      out.write("                    </select> \r\n");
      out.write("                  </div>\r\n");
      out.write("                  <div class=\"form-group\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" placeholder=\"상품명 입력..\" name=\"product_name\">\r\n");
      out.write("                  </div>\r\n");
      out.write("                  \r\n");
      out.write("                  <div class=\"form-group\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" placeholder=\"가격 입력..\" name=\"price\">\r\n");
      out.write("                  </div>\r\n");
      out.write("                  \r\n");
      out.write("                  <div class=\"form-group\">\r\n");
      out.write("                    <textarea id=\"introduce\" placeholder=\"상품간략 소개\" name=\"introduce\">상품 간략 소개</textarea>\r\n");
      out.write("                  </div>\r\n");
      out.write("                  \r\n");
      out.write("                  <div class=\"form-group\">\r\n");
      out.write("                    <textarea id=\"detail\" name=\"detail\">상품 상세 정보</textarea>\r\n");
      out.write("                  </div>\r\n");
      out.write("                  \r\n");
      out.write("                  <div class=\"form-group\">\r\n");
      ...
      out.write("                        <input type=\"file\" class=\"custom-file-input\" multiple name=\"imgFiles\">\r\n");
      ...
      out.write("                  <button type=\"button\" class=\"btn btn-info\" id=\"bt_regist\">등록</button>\r\n");
      out.write("                  <button type=\"button\" class=\"btn btn-info\" onClick=\"location.href='/admin/product/list';\">목록</button>\r\n");
      out.write("                </div>\r\n");
      out.write("              </form>\r\n");
      out.write("            </div>\r\n");
      out.write("            </div>\r\n");
      out.write("          <!-- 상품 등록폼 end -->\r\n");
      out.write("            \r\n");
      out.write("            <!-- /.card -->\r\n");
      out.write("          </div>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("<script src=\"/resources/admin/plugins/summernote/summernote-bs4.min.js\"></script>\r\n");
      out.write("\r\n");
      out.write("<!-- bs-custom-file-input 파일컴포넌트 커스터마이징 -->\r\n");
      ...
      out.write(" $(function () {\r\n");
      out.write("    // Summernote\r\n");
      out.write("    $('#introduce').summernote();  \r\n");
      out.write("    $('#detail').summernote();  \r\n");
      out.write("    \r\n");
      out.write("    //이미지 미리보기 버튼 이벤트 \r\n");
      out.write("    \r\n");
      out.write("    \r\n");
      out.write("    $(\"input[name='imgFiles']\").change(function(){\r\n");
      out.write("		preview2(this);		    	\r\n");
      out.write("    });\r\n");
      out.write("	/*\r\n");
      out.write("	document.querySelector(\"input[name='imgFiles']\").addEventListener(\"change\", function(){\r\n");
      out.write("		preview(this);		\r\n");
      out.write("	});\r\n");
      out.write("	*/\r\n");
      out.write("	\r\n");
      ...
      out.write("})\r\n");
      out.write("\r\n");
      out.write("//select 컴포넌트에 선택한 카테고리 반영하기!!\r\n");
      out.write("function selCategory(category_name, category_id){\r\n");
      out.write("	var sel = document.querySelector(\"#category_id\");\r\n");
      out.write("	sel.options[0].text=category_name; //사용자가 보게될 옵션의 제목 	\r\n");
      out.write("	sel.options[0].value=category_id; //사용자가 보게될 옵션의 값 	\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function regist(){\r\n");
      out.write("	form1.action=\"/admin/product/regist\";\r\n");
      out.write("	form1.method=\"post\";\r\n");
      out.write("	form1.encoding=\"multipart/form-data\";\r\n");
      out.write("	form1.submit();\r\n");
      out.write("}\r\n");
      out.write(" \r\n");
      out.write("//제이쿼리로도 처리해 본다\r\n");
      out.write("function preview2(obj){\r\n");
      out.write("	for(var i=0;i<obj.files.length;i++){		\r\n");
      out.write("		var reader = new FileReader();\r\n");
      out.write("		reader.onload=function(e){\r\n");
      out.write("		 $(\"#preview\").append($(\"<img src='\"+e.target.result+\"' width='100px'>\"));\r\n");
      out.write("		 \r\n");
      out.write("		}\r\n");
      out.write("		reader.readAsDataURL(obj.files[i]);\r\n");
      out.write("	}\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//자바스크립트도 stream이 지원된다..\r\n");
      out.write("function preview(obj){\r\n");
      out.write("	console.log(\"이벤트를 발생시킨 컴포넌트는 \", obj);\r\n");
      out.write("	console.log(\"obj.files is \", obj.files);\r\n");
      out.write("	\r\n");
      out.write("	for(var i=0;i<obj.files.length;i++){\r\n");
      out.write("		//파일에 대한 접근방법을 알았으니, 지금부터는 실제 파일을 읽어와보자!! 그러기 위해서는 스트림 객체가 필요하다\r\n");
      out.write("		var reader = new FileReader();\r\n");
      out.write("		\r\n");
      out.write("		reader.onload=function(e){\r\n");
      out.write("			console.log(\"읽어들인 정보 e는 \", e);\r\n");
      out.write("			\r\n");
      out.write("			//div에 동적으로 img 돔을 생성하여 그 돔의 src속서에 e.target.result\r\n");
      out.write("			var img=document.createElement(\"img\");\r\n");
      out.write("			img.src=e.target.result;\r\n");
      out.write("			img.style.width=100+\"px\";\r\n");
      out.write("			\r\n");
      out.write("			document.getElementById(\"preview\").appendChild(img); //동적으로 이미지 돔을 div에 넣기!!\r\n");
      out.write("			\r\n");
      out.write("		}; //파일을 다 읽어들이면, 익명함수가 호출된다..\r\n");
      out.write("		\r\n");
      out.write("		\r\n");
      out.write("		reader.readAsDataURL(obj.files[i]); //파일 읽어들이기...\r\n");
      out.write("	}\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("</body>\r\n");
